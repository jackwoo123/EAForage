...
#modified by Jack Woo for EA forage, jackpatrickwoo@gmail.com
import pygame
...
def startGame():
      ...
      for column in range(19):
          if (row == 7 or row == 8) and (column == 8 or column == 9 or column == 10):
            ...
            if b_collide:
              ...
              block_list.add(block)  #all blocks, not ghosts are added here
  ...
  while done == False:
      ...
      #if pac man collides with a ghost, delete that ghost.
